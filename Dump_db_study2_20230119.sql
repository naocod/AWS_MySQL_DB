...
--
-- Table structure for table `insructor_mst`
--

DROP TABLE IF EXISTS `insructor_mst`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `insructor_mst` (
  `insructor_id` int NOT NULL,
  `insructor_name` varchar(45) NOT NULL,
  `university_code` int DEFAULT NULL,
  PRIMARY KEY (`insructor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `insructor_mst`
--

LOCK TABLES `insructor_mst` WRITE;
/*!40000 ALTER TABLE `insructor_mst` DISABLE KEYS */;
INSERT INTO `insructor_mst` VALUES (1,'김준일',1),(2,'김준이',2),(3,'김준삼',3);
/*!40000 ALTER TABLE `insructor_mst` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-19 17:41:05
